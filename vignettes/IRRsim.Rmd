...
for(i in row.names(guidelines.table)) {
	...
	guidelines.table[i,]$IRRMetric <- paste0(IRRguidelines[[i]]$metrics, collapse = ', ')
...
tests.4levels <- simulateICC(nRaters = c(6, 9, 12), nLevels = 4)
```
...
```{r plotall, fig.width=6.5, fig.height=4}
plot(tests.4levels)
```
